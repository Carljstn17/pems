@extends('layout.owner')
    ...
    @section('content')
        <div class="py-2 mt-2">
            <i class="fs-5 bi-card-checklist"></i> <span class="d-sm-inline fs-5 head">Estimate | Reject</span>
        </div>
        ...
        <div class="px-3 d-flex justify-content-end">
            <a href="{{ route('owner.estimate') }}" class="text-decoration-none text-secondary mt-1">/View Latest Estimate</a>
        </div>
