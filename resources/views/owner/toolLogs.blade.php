@extends('layout.owner')
    ...
    @section('content')
        <div class="py-2 mt-2">
            ...
            <i class="fs-5 bi-tools"></i> <span class="d-sm-inline fs-5 head">Tools | Logs</span>
            </div>
        </div>

        <div class="pb-2 m-3">
            <div class="d-flex justify-content-between">
                <a href="{{ route('owner.tool') }}" class="btn btn-outline-dark">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    @foreach($toolLogs as $log) 
                            <tr>
                                <td class="text-nowrap" data-toggle="tooltip" title="{{ $log->toolLog->tool_type }}">{{ $log->toolLog->property }}</td>
