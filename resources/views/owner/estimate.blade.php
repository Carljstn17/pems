@extends('layout.owner')
    ...
    @section('content')
        ...
        <div class="py-2 mt-2">
            <i class="fs-5 bi-card-checklist"></i> <span class="fs-5 head d-sm-inline">Estimate | Latest</span>
        </div>
        ...
        <div class="px-3 d-flex justify-content-between">
            <a href="{{ route('owner.estimateReject') }}" class="link-secondary text-decoration-none fst-italic">
