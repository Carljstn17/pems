    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-4">
            ...
            <div class="d-flex justify-content-between gap-3">
                ...
                @else
                    <div class="text-danger float-end" style="width:40%;">verify your own email to reset password.</div>
                @endif
            </div>
        </div>
                ...
                <div class="modal fade" id="confirmResetModal" tabindex="-1" role="dialog" aria-labelledby="confirmResetModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Are you sure you want to reset the password to the user's birthday? This action cannot be undone.
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
