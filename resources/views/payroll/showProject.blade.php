@extends('layout.staff')
    ...
    @section('content')
        ...
        <div class="px-3 d-flex justify-content-between">
            <a href="{{ route('on.payroll') }}" class="link-secondary text-decoration-none fst-italic">
                <span class="d-none d-sm-inline text-nowrap">/Payroll for On-Going Projects</span>
                <span class="d-sm-inline d-sm-none">/On-Going Projects</span>
            </a>
