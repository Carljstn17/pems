@extends('layout.staff')
    ...
    @section('content')
        <div class="py-2 mt-2">
            <i class="fs-5 bi-receipt"></i> <span class="d-sm-inline fs-5 head">Receipt | On-Going Projects</span>
        </div>
        ...
        <div class="mt-3 pt-2 border-top border-subtle d-flex justify-content-between">
            <a href="{{ route('latest.receipt') }}" class="text-decoration-none text-secondary fst-italic">/View latest receipt</a>
